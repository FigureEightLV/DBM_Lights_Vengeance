-- ------------------------------------- --
--   Tempest Keep - French localization  --
--   Version:	1.0   			 --
--   Author(s): Arta		         --
--   Date:	01 May 2008              --
-- ------------------------------------- --
...
DBM_MECHANAR			= "Le Méchanar"
DBM_BOTANICA			= "La Botanica"
DBM_ARCATRAZ			= "L'Arcatraz"


-- Mechano-Lord Capacitus
DBM_CAPACITUS_NAME			= "Mécano-seigneur Capacitus"
DBM_CAPACITUS_DESCRIPTION		= "Les avertissements et les minuteurs pour Mécano-seigneur Capacitus" 
...
DBM_SEPETHREA_NAME			= "Néantomancien Sepethrea"
DBM_SEPETHREA_DESCRIPTION		= "Les avertissements et les minuteurs pour Néantomancien Sepethrea"

-- Pathaleon the Calculator
DBM_PATHALEON_NAME		= "Pathaleon le Calculateur"
DBM_PATHALEON_DESCRIPTION	= "Les avertissements et les minuteurs pour Pathaleon le Calculateur"
...
-- Commander Sarannis
DBM_SARANNIS_NAME			= "Commandant Sarannis"
DBM_SARANNIS_DESCRIPTION		= "Les avertissements et les minuteurs pour Commandant Sarannis"

-- High Botanist Freywinn
DBM_FREYWINN_NAME			= "Grand botaniste Freywinn"
DBM_FREYWINN_DESCRIPTION		= "Les avertissements et les minuteurs pour Grand botaniste Freywinn"
...
DBM_THORNGRIN_NAME			= "Rirépine le Tendre"
DBM_THORNGRIN_DESCRIPTION		= "Les avertissements et les minuteurs pour Rirépine le Tendre"

-- Laj
DBM_LAJ_DESCRIPTION		= "Les avertissements et les minuteurs pour Laj"

DBM_LAJ_OPTION_ALLERGIC		= "Warns for Allergic Reaction"
DBM_LAJ_WARN_ALLERGIC		= ">%s< has Allergic Reaction"

-- Warp Splinter
DBM_SPLINTER_NAME			= "Brise-dimension"
DBM_SPLINTER_DESCRIPTION		= "Les avertissements et les minuteurs pour Brise-dimension"


-- Zereketh the Unbound
DBM_ZEREKETH_NAME			= "Zereketh le Délié"
DBM_ZEREKETH_DESCRIPTION		= "Les avertissements et les minuteurs pour Zereketh le Délié"
...
DBM_SOCCO_NAME			= "Scrute-courroux Soccothrates"
DBM_SOCCO_DESCRIPTION		= "Les avertissements et les minuteurs pour Scrute-courroux Soccothrates"

DBM_SOCCO_OPTION_KNOCK		= "Warns for Knock Away"
DBM_SOCCO_WARN_KNOCK		= "Knock Away"

-- Dalliah the Doomsayer
DBM_DALLIAH_NAME		= "Dalliah l'Auspice-funeste"
DBM_DALLIAH_DESCRIPTION		= "Les avertissements et les minuteurs pour Dalliah l'Auspice-funeste"
...
-- Harbinger Skyriss
DBM_SKYRISS_NAME		= "Messager Cieuriss"
DBM_SKYRISS_DESCRIPTION		= "Les avertissements et les minuteurs pour Messager Cieuriss"
