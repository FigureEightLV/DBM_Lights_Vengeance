DBM_MECHANAR					= "The Mechanar"
DBM_BOTANICA					= "The Botanica"
DBM_ARCATRAZ					= "The Arcatraz"
DBM_TK_TAB						= "TempestTab"
...
DBM_CAPACITUS_NAME				= "Mechano-Lord Capacitus"
...
DBM_SEPETHREA_NAME				= "Nethermancer Sepethrea"
DBM_SEPETHREA_DESCRIPTION		= "Announces and timers for Nethermancer Sepethrea"

-- Pathaleon the Calculator
DBM_PATHALEON_NAME				= "Pathaleon the Calculator"
...
DBM_PATHALEON_OPTION_SUMMON		= "Warns for summoned adds"
DBM_PATHALEON_WARN_MC			= ">%s< is Mind Controlled"
DBM_PATHALEON_WARN_SUMMON		= "Adds summoned"


-- Commander Sarannis
DBM_SARANNIS_NAME				= "Commander Sarannis"
DBM_SARANNIS_DESCRIPTION		= "Announces and timers for Commander Sarannis"

-- High Botanist Freywinn
DBM_FREYWINN_NAME				= "High Botanist Freywinn"
...
DBM_THORNGRIN_NAME				= "Thorngrin the Tender"
DBM_THORNGRIN_DESCRIPTION		= "Announces and timers for Thorngrin the Tender"

DBM_THORNGRIN_OPTION_SACRIFICE	= "Warn for Sacrifice"
DBM_THORNGRIN_WARN_SACRIFICE	= "Sacrificing: >%s<"
...
-- Warp Splinter
DBM_SPLINTER_NAME				= "Warp Splinter"
DBM_SPLINTER_DESCRIPTION		= "Announces and timers for Warpsplinter"


-- Zereketh the Unbound
DBM_ZEREKETH_NAME				= "Zereketh the Unbound"
...
DBM_SOCCO_NAME					= "Wrath-Scryer Soccothrates"
...
DBM_DALLIAH_NAME				= "Dalliah the Doomsayer"
...
-- Harbinger Skyriss
DBM_SKYRISS_NAME				= "Harbinger Skyriss"
