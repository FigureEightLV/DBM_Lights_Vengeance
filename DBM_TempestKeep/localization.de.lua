-- ------------------------------------- --
--   Tempest Keep - German localization  --
--   Version:	1.0   			 --
--   Author: 	Arta		         --
--   Date:	01 May 2008              --
-- ------------------------------------- --
...
DBM_MECHANAR			= "Die Mechanar"
DBM_BOTANICA			= "Die Botanika"
...
DBM_SEPETHREA_NAME			= "Nethermantin Sepethrea"
DBM_SEPETHREA_DESCRIPTION		= "Ansages und Zeitgebers für Nethermantin Sepethrea"

-- Pathaleon the Calculator
DBM_PATHALEON_NAME		= "Pathaleon der Kalkulator"
DBM_PATHALEON_DESCRIPTION	= "Ansages und Zeitgebers für Pathaleon der Kalkulator"
...
-- Commander Sarannis
DBM_SARANNIS_NAME			= "Kommandant Sarannis"
DBM_SARANNIS_DESCRIPTION		= "Ansages und Zeitgebers für Kommandant Sarannis"

-- High Botanist Freywinn
DBM_FREYWINN_NAME			= "Hochbotaniker Freywinn"
DBM_FREYWINN_DESCRIPTION		= "Ansages und Zeitgebers für Hochbotaniker Freywinn"
...
DBM_THORNGRIN_NAME			= "Dorngrin der Hüter"
DBM_THORNGRIN_DESCRIPTION		= "Ansages und Zeitgebers für Dorngrin der Hüter"

-- Laj
DBM_LAJ_DESCRIPTION		= "Ansages und Zeitgebers für Laj"

DBM_LAJ_OPTION_ALLERGIC		= "Warns for Allergic Reaction"
DBM_LAJ_WARN_ALLERGIC		= ">%s< has Allergic Reaction"

-- Warp Splinter
DBM_SPLINTER_NAME			= "Warpzweig"
DBM_SPLINTER_DESCRIPTION		= "Ansages und Zeitgebers für Warpzweig"


-- Zereketh the Unbound
DBM_ZEREKETH_NAME			= "Zereketh der Unabhängige"
DBM_ZEREKETH_DESCRIPTION		= "Ansages und Zeitgebers für Zereketh der Unabhängige"
...
DBM_SOCCO_NAME			= "Zornseher Soccothrates"
DBM_SOCCO_DESCRIPTION		= "Ansages und Zeitgebers für Zornseher Soccothrates"

DBM_SOCCO_OPTION_KNOCK		= "Warns for Knock Away"
DBM_SOCCO_WARN_KNOCK		= "Knock Away"

-- Dalliah the Doomsayer
DBM_DALLIAH_NAME		= "Dalliah die Verdammnisverkünderin"
DBM_DALLIAH_DESCRIPTION		= "Ansages und Zeitgebers für Dalliah die Verdammnisverkünderin"
