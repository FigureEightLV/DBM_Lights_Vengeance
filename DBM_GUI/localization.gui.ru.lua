...
DBMGUI_DISABLE_ADDON			= "Выключить";
DBMGUI_ENABLE_ADDON			    = "Включить";
...
DBMGUI_TITLE_AGGROALERT			        = "Предупреждение о наборе угрозы";
...
DBMGUI_CHECKBOX_AGGROALERT_ENABLE		= "Предупреждать о наборе угрозы";
...
DBMGUI_BUTTON_AGGROALERT_ENABLE_PARTY	= "Предупреждать о наборе угрозы в подземельях 5 чел.";
DBMGUI_CHECKBOX_AGGROALERT_PLAYSOUND	= "Звук при наборе угрозы";
DBMGUI_CHECKBOX_AGGROALERT_FLASH		= "Вспышка при наборе угрозы";
DBMGUI_CHECKBOX_AGGROALERT_SHAKE		= "Вибрация при наборе угрозы";
...
DBMGUI_BUTTON_MOVEABLEBAR			    = "Тест движения";
...
DBMGUI_SLIDER_SPECWARNING_TEXTSIZE		= "Размер текста";
...
DBMGUI_ABOUTTITLE	= "О Deadly Boss Mod";
DBMGUI_ABOUTTEXT	= {
	"Deadly Boss Mod API (c), DeadlyMinds Tandanu",
	"Deadly Boss Mod GUI (c), La Vendetta Nitram",
	" ",
...
DBMGUI_DROPDOWN_STATUSBAR_DESIGN_1		= "Классический"; --wird ьberflьssig mit dem Verwenden des Namens aus der Tabelle
DBMGUI_DROPDOWN_STATUSBAR_DESIGN_2		= "Современный"; 
DBMGUI_DROPDOWN_STATUSBAR_EXAMPLE_BAR	= "Пример полосы";

DBMGUI_TITLE_AUTORESPOND			        = "Автоматический ответ";
...
DBMGUI_EDITBOX_AUTORESPOND_TOOLTIP_TEXT2	= {"%B", "имя главаря"};
DBMGUI_EDITBOX_AUTORESPOND_TOOLTIP_TEXT3	= {"%HP", "здоровье главаря"};
...
DBMGUI_FRAME_LOADADDON_DESCRIPTION		= {
	...
	"вручную, нажмите кнопку \"Выбрать зону\".",
	"После загрузки и запуска в работу модулей,",
	"может быть задействована память процессора.",
	"Эта функция снижает производительность,",
	"поэтому не рекомендуем загружать сразу все.",
};
...
DBMGUI_CHECKBOX_LOAD_GUI_ONLOAD	    = "Загружать GUI при входе";	
