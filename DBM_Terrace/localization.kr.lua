...
DBM_TERRACE			= "Magisters' Terrace"


-- Selin Fireheart
DBM_SELIN_NAME			= "Selin Fireheart"
...
-- Priestess Delrissa							
DBM_DELRISSA_NAME			= "Priestess Delrissa"		
...
DBM_KAEL_PULL			= "Don't look so smug! I know what you're thinking, but Tempest Keep was merely a set back. Did you honestly believe I would trust the future to some blind, half-night elf mongrel?"
DBM_KAEL_PULL2			= "Oh no, he was merely an instrument, a stepping stone to a much larger plan! It has all led to this... and this time you will not interfere!"
