...
DBM_TERRACE			= "Bancal del Magister"


-- Selin Fireheart
DBM_SELIN_NAME			= "Selin corazón de fuego"
DBM_SELIN_DESCRIPTION		= "Las advertencias y los relojes para Selin corazón de fuego"
...
-- Vexallus
DBM_VEXALLUS_DESCRIPTION	= "Las advertencias y los relojes para Vexallus"
...
-- Priestess Delrissa							
DBM_DELRISSA_NAME			= "Sacerdotisa Delrissa"		
DBM_DELRISSA_DESCRIPTION		= "Las advertencias y los relojes para Sacerdotisa Delrissa"
...
DBM_KAEL_DESCRIPTION		= "Las advertencias y los relojes para Kael’thas Caminante del Sol"
